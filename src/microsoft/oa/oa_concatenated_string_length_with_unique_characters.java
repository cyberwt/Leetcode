 ...
 */
public class oa_concatenated_string_length_with_unique_characters {
    private int result;
    ...
    public static void main(String[] args) {
        oa_concatenated_string_length_with_unique_characters s = new oa_concatenated_string_length_with_unique_characters();
